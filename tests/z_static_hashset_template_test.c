...
//
// A set is generated by leaving _ZP_STATIC_HASHMAP_TEMPLATE_VAL_TYPE undefined.
...
#define _ZP_STATIC_HASHMAP_TEMPLATE_NAME u32set
...
#define _ZP_STATIC_HASHMAP_TEMPLATE_KEY_TYPE owned_str_t
#define _ZP_STATIC_HASHMAP_TEMPLATE_NAME strset
#define _ZP_STATIC_HASHMAP_TEMPLATE_CAPACITY 8
#define _ZP_STATIC_HASHMAP_TEMPLATE_KEY_HASH_FN owned_str_hash
#define _ZP_STATIC_HASHMAP_TEMPLATE_KEY_EQ_FN owned_str_eq
#define _ZP_STATIC_HASHMAP_TEMPLATE_KEY_DESTROY_FN(p) free((p)->str)
#include "zenoh-pico/collections/static_hashmap_template.h"
