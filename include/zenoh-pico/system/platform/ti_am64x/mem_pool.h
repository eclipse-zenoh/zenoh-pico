...
//
// Pool allocator public API for TI AM64x Cortex-R5F.
// Include this header from application code to monitor pool usage.

#ifndef ZENOH_PICO_SYSTEM_TI_AM64X_MEM_POOL_H
#define ZENOH_PICO_SYSTEM_TI_AM64X_MEM_POOL_H
...
#endif  /* ZENOH_PICO_SYSTEM_TI_AM64X_MEM_POOL_H */
