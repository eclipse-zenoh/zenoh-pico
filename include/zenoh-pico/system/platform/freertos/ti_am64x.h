...
//
// Platform types for TI AM64x Cortex-R5F with FreeRTOS + lwIP.
// Mirrors freertos/lwip.h but targets ZENOH_TI_AM64X builds.

#ifndef ZENOH_PICO_SYSTEM_FREERTOS_TI_AM64X_TYPES_H
#define ZENOH_PICO_SYSTEM_FREERTOS_TI_AM64X_TYPES_H
...
#error "Bluetooth not supported on TI AM64x port of Zenoh-Pico"
#endif

#if Z_FEATURE_LINK_SERIAL == 1
#error "Serial not supported on TI AM64x port of Zenoh-Pico"
#endif

#if Z_FEATURE_RAWETH_TRANSPORT == 1
#error "Raw ethernet transport not supported on TI AM64x port of Zenoh-Pico"
#endif
...
#endif  // ZENOH_PICO_SYSTEM_FREERTOS_TI_AM64X_TYPES_H
