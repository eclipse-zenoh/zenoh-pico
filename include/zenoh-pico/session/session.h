...
_Z_ELEM_DEFINE(_z_subscription, _z_subscription_t, _z_noop_size, _z_subscription_clear, _z_noop_copy)
_Z_POINTER_DEFINE(_z_subscription, _z_subscription_t);
_Z_LIST_SPTR_DEFINE(_z_subscription)
...
_Z_LIST_SPTR_DEFINE(_z_questionable)
