...
_z_questionable_list_t *_z_get_questionable_by_key(_z_session_t *zn, const _z_keyexpr_t key);
...
void _z_unregister_questionable(_z_session_t *zn, _z_questionable_t *q);
