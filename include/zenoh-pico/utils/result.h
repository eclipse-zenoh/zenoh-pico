...
typedef enum {
    ...
    _Z_ERR_TRANSPORT_NOT_AVAILABLE = -8,
    ...
    _Z_ERR_DESERIALIZING_TRANSPORT_MESSAGE = -16,
    _Z_ERR_RESOURCE_DECLARATION = -20,
    _Z_ERR_UNKNOWN_SCHEMA = -21,
    _Z_ERR_UNKNOWN_SUBSCRIPTION = -21,
    _Z_ERR_UNKNOWN_QUERYABLE = -22,
    _Z_ERR_UNKNOWN_KEYEXPR = -22,
    _Z_ERR_UNKNOWN_QUERY = -22,
    _Z_ERR_NOT_MATCHING_QUERY = -22,
    _Z_ERR_OLDER_DATA_QUERY = -22,
    _Z_ERR_KEYEXPR_NOT_MATCH = -23,
    _Z_ERR_FAILED_REGISTER_QUERY = -23,
    _Z_ERR_FAILED_REGISTER_KEYEXPR = -23,
    _Z_ERR_TX_CONNECTION = -24,
    _Z_ERR_RX_CONNECTION = -24,
    _Z_ERR_UNKNOWN_MESSAGE = -25,
    _Z_ERR_SCOUTING_UNKNOWN_TRANSPORT = -25,
    _Z_ERR_UNEXPECTED_MESSAGE = -25,
    _Z_ERR_UNEXPECTED_MESSAGE_FLAG = -25,
    _Z_ERR_UNEXPECTED_MESSAGE_DECLARATION = -25,
    _Z_ERR_TASK_START_FAILED = -26,
    _Z_ERR_CONFIG_FAILED_INSERT = -26,
    _Z_ERR_OPEN_FAILED_SN_RESOLUTION = -26,
    _Z_ERR_IOBUFFER_FAILED_WRITE = -26,
    _Z_ERR_UNSUPPORTED_CLIENT_MULTICAST = -26,
    _Z_ERR_UNSUPPORTED_PEER_UNICAST = -26,
    _Z_ERR_GENERIC = -127
} _z_res_t;
