...
// ── Remap _ZP_STATIC_HASHSET_* macros to _ZP_STATIC_HASHMAP_* for the internal template ──

#ifdef _ZP_STATIC_HASHSET_TEMPLATE_KEY_TYPE
#define _ZP_STATIC_HASHMAP_TEMPLATE_KEY_TYPE _ZP_STATIC_HASHSET_TEMPLATE_KEY_TYPE
#endif

#ifdef _ZP_STATIC_HASHSET_TEMPLATE_KEY_HASH_FN
#define _ZP_STATIC_HASHMAP_TEMPLATE_KEY_HASH_FN _ZP_STATIC_HASHSET_TEMPLATE_KEY_HASH_FN
#endif

#ifdef _ZP_STATIC_HASHSET_TEMPLATE_KEY_EQ_FN
#define _ZP_STATIC_HASHMAP_TEMPLATE_KEY_EQ_FN _ZP_STATIC_HASHSET_TEMPLATE_KEY_EQ_FN
#endif

#ifdef _ZP_STATIC_HASHSET_TEMPLATE_NAME
#define _ZP_STATIC_HASHMAP_TEMPLATE_NAME _ZP_STATIC_HASHSET_TEMPLATE_NAME
#endif

#ifdef _ZP_STATIC_HASHSET_TEMPLATE_CAPACITY
#define _ZP_STATIC_HASHMAP_TEMPLATE_CAPACITY _ZP_STATIC_HASHSET_TEMPLATE_CAPACITY
#endif

#ifdef _ZP_STATIC_HASHSET_TEMPLATE_KEY_DESTROY_FN
#define _ZP_STATIC_HASHMAP_TEMPLATE_KEY_DESTROY_FN _ZP_STATIC_HASHSET_TEMPLATE_KEY_DESTROY_FN
#endif

#ifdef _ZP_STATIC_HASHSET_TEMPLATE_KEY_MOVE_FN
#define _ZP_STATIC_HASHMAP_TEMPLATE_KEY_MOVE_FN _ZP_STATIC_HASHSET_TEMPLATE_KEY_MOVE_FN
#endif
