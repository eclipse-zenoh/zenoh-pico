...
z_result_t _z_bytes_to_uint8(const _z_bytes_t *bs, uint8_t *u);
z_result_t _z_bytes_to_uint16(const _z_bytes_t *bs, uint16_t *u);
z_result_t _z_bytes_to_uint32(const _z_bytes_t *bs, uint32_t *u);
z_result_t _z_bytes_to_uint64(const _z_bytes_t *bs, uint64_t *u);
z_result_t _z_bytes_to_float(const _z_bytes_t *bs, float *f);
z_result_t _z_bytes_to_double(const _z_bytes_t *bs, double *d);
z_result_t _z_bytes_to_slice(const _z_bytes_t *bytes, _z_slice_t *s);
z_result_t _z_bytes_from_slice(_z_bytes_t *b, _z_slice_t s);
z_result_t _z_bytes_from_uint8(_z_bytes_t *b, uint8_t val);
...
z_result_t _z_bytes_from_float(_z_bytes_t *b, float val);
...
z_result_t _z_bytes_writer_append(_z_bytes_writer_t *writer, _z_bytes_t *bytes);
...
z_result_t _z_bytes_iterator_writer_write(_z_bytes_iterator_writer_t *writer, _z_bytes_t *bytes);
