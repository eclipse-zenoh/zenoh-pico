...
#ifndef INCLUDE_ZENOH_PICO_NET_SAMPLE_MISS_H
#define INCLUDE_ZENOH_PICO_NET_SAMPLE_MISS_H
...
typedef struct _ze_sample_miss_listener_t {
    uint32_t _id;
} _ze_sample_miss_listener_t;

#if Z_FEATURE_ADVANCED_SUBSCRIPTION == 1
_ze_sample_miss_listener_t _ze_sample_miss_listener_declare(_z_session_rc_t *zn, const _z_keyexpr_t *key,
                                                            _z_zint_t entity_id, uint8_t interest_type_flag,
...
#endif /* INCLUDE_ZENOH_PICO_NET_SAMPLE_MISS_H */
