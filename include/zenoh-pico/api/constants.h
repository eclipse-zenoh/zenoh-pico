...
inline z_congestion_control_t z_internal_congestion_control_default_push(void) { return Z_CONGESTION_CONTROL_DROP; }
inline z_congestion_control_t z_internal_congestion_control_default_request(void) { return Z_CONGESTION_CONTROL_BLOCK; }
inline z_congestion_control_t z_internal_congestion_control_default_response(void) {
