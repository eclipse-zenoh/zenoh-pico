...
#define z_loan(x) _Generic((x),                            \
                           ...
                           : z_queryable_loan,             \
                             z_owned_encoding_t            \
                           : z_encoding_loan,              \
                             z_owned_query_target_t        \
                           : z_query_target_loan,          \
                             z_owned_query_consolidation_t \
                           : z_query_consolidation_loan,   \
                             z_owned_sample_t              \
                           : z_sample_loan,                \
                             z_owned_hello_t               \
                           : z_hello_loan,                 \
...
#define z_check(x) _Generic((x),                            \
                            ...
                            : z_encoding_check,             \
                              z_owned_query_target_t        \
                            : z_query_target_check,         \
                              z_owned_query_consolidation_t \
                            : z_query_consolidation_check,  \
                              z_owned_sample_t              \
                            : z_sample_check,               \
                              z_owned_hello_t               \
                            : z_hello_check,                \
...
#define z_move(x) _Generic((x),                            \
                           ...
                           : z_closure_sample_move,        \
                             z_owned_closure_query_t       \
                           : z_closure_query_move,         \
                             z_owned_closure_reply_t       \
                           : z_closure_reply_move,         \
...
#define z_clone(x) _Generic((x),                            \
                            ...
                            : z_encoding_clone,             \
                              z_owned_query_target_t        \
                            : z_query_target_clone,         \
                              z_owned_query_consolidation_t \
                            : z_query_consolidation_clone,  \
                              z_owned_sample_t              \
                            : z_sample_clone,               \
                              z_owned_hello_t               \
                            : z_hello_clone,                \
