...
#define Z_PTHREAD_STACK_SIZE_DEFAULT (CONFIG_ZENOH_PICO_STACK_SIZE + CONFIG_TEST_EXTRA_STACK_SIZE)
#elif CONFIG_TEST_EXTRA_STACKSIZE
#define Z_PTHREAD_STACK_SIZE_DEFAULT (CONFIG_ZENOH_PICO_STACK_SIZE + CONFIG_TEST_EXTRA_STACKSIZE)
#else
#define Z_PTHREAD_STACK_SIZE_DEFAULT CONFIG_ZENOH_PICO_STACK_SIZE
#endif
