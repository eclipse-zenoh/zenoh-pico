...
const _z_udp_unicast_ops_t _z_udp_zephyr_unicast_ops = {
    .endpoint_init = _z_udp_zephyr_endpoint_init,
    .endpoint_clear = _z_udp_zephyr_endpoint_clear,
    .open = _z_udp_zephyr_open,
    .listen = _z_udp_zephyr_listen,
    .close = _z_udp_zephyr_close,
    .read = _z_udp_zephyr_read,
    .read_exact = _z_udp_zephyr_read_exact,
    .write = _z_udp_zephyr_write,
};
