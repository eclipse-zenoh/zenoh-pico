...
const _z_serial_ops_t _z_uart_flipper_serial_ops = {
    .open_from_pins = _z_uart_flipper_open_from_pins,
    .open_from_dev = _z_uart_flipper_open_from_dev,
    .listen_from_pins = _z_uart_flipper_listen_from_pins,
    .listen_from_dev = _z_uart_flipper_listen_from_dev,
    .close = _z_uart_flipper_close,
    .read = _z_uart_flipper_read,
    .write = _z_uart_flipper_write,
};
