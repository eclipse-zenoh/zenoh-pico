...
const _z_serial_ops_t _z_uart_zephyr_serial_ops = {
    .open_from_pins = _z_zephyr_uart_open_from_pins,
    .open_from_dev = _z_zephyr_uart_open_from_dev,
    .listen_from_pins = _z_zephyr_uart_listen_from_pins,
    .listen_from_dev = _z_zephyr_uart_listen_from_dev,
    .close = _z_zephyr_uart_close,
    .read = _z_zephyr_uart_read,
    .write = _z_zephyr_uart_write,
};
