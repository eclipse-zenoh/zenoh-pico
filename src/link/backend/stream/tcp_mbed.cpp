...
extern const _z_stream_ops_t _z_tcp_mbed_stream_ops = {
    .endpoint_init = _z_tcp_mbed_endpoint_init,
    .endpoint_clear = _z_tcp_mbed_endpoint_clear,
    .open = _z_tcp_mbed_open,
    .listen = _z_tcp_mbed_listen,
    .close = _z_tcp_mbed_close,
    .read = _z_tcp_mbed_read,
    .read_exact = _z_tcp_mbed_read_exact,
    .write = _z_tcp_mbed_write,
};
}  // extern "C"
