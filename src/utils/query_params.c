...
const char *_Z_QUERY_PARAMS_KEY_RANGE = "_sn";
const char *_Z_QUERY_PARAMS_KEY_MAX = "_max";

const char *_Z_QUERY_PARAMS_LIST_SEPARATOR = ";";
const char *_Z_QUERY_PARAMS_FIELD_SEPARATOR = "=";
