...
// size_t
// _zn_send_s_msg(_zn_socket_t sock, z_iobuf_t *buf, _zn_session_message_t *m)
// {
//     _Z_DEBUG(">> send_msg\n");
//     z_iobuf_clear(buf);
...
// z_zint_result_t
// _zn_recv_zint(_zn_socket_t sock)
// {
//     z_zint_result_t r;
//     uint8_t buf[10];
//     int n;
...
//         _Z_DEBUG_VA(">> recv_zint [%d] : 0x%x\n", i, buf[i]);
//     } while ((buf[i++] > 0x7f) && (n != 0) && (i < 10));

//     if (n == 0 || i > 10)
//     {
//         r.tag = Z_ERROR_TAG;
//         r.value.error = Z_ZINT_PARSE_ERROR;
//         return r;
//     }
//     z_iobuf_t iobuf;
//     iobuf.capacity = 10;
...
// _zn_recv_s_msg(_zn_socket_t sock, z_iobuf_t *buf)
// {
//     _zn_session_message_p_result_t r;
//     _zn_session_message_p_result_init(&r);
//     _zn_recv_s_msg_na(sock, buf, &r);
//     return r;
//     // z_iobuf_clear(buf);
//     // _Z_DEBUG(">> recv_msg\n");
...
//     // r.tag = Z_ERROR_TAG;
//     // z_zint_result_t r_zint = z_recv_zint(sock);
//     // ASSURE_RESULT(r_zint, r, Z_ZINT_PARSE_ERROR)
//     // size_t len = r_zint.value.zint;
//     // _Z_DEBUG_VA(">> \t msg len = %zu\n", len);
//     // if (z_iobuf_writable(buf) < len) {
//     //   r.tag = Z_ERROR_TAG;
