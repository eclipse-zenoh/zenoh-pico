...
// int _zn_link_send_t_msg(const _zn_link_t *link, const zn_t_message msg)
// {
//     _z_wbuf_t wbf = _z_wbuf_make(link->get_mtu(), 0);
...
// int _zn_link_recv_t_msg(const _zn_link_t *link, const zn_t_message msg)
// {
//     _z_wbuf_t wbf = _z_wbuf_make(link->get_mtu(), 0);
//     // do the encoding here
