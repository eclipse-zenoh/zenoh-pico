...
char* _zn_parse_port_segment_udp_unicast(const char *address)
{
...
char* _zn_parse_address_segment_udp_unicast(const char *address)
{
...
_zn_socket_result_t _zn_f_link_open_udp_unicast(void *arg, const clock_t tout)
{
    ...
    r.value.socket = _zn_open_udp_unicast(self->endpoint_syscall, tout);
    if (r.value.socket < 0)
    {
        r.tag = _z_res_t_ERR;
...
_zn_socket_result_t _zn_f_link_listen_udp_unicast(void *arg, const clock_t tout)
{
    ...
    r.value.socket = _zn_listen_udp_unicast(self->endpoint_syscall, tout);
    if (r.value.socket < 0)
    {
        r.tag = _z_res_t_ERR;
        r.value.error = _zn_err_t_OPEN_TRANSPORT_FAILED;
...
int _zn_f_link_close_udp_unicast(void *arg)
{
    _zn_link_t *self = (_zn_link_t*)arg;

    return _zn_close_udp_unicast(self->sock);
}

void _zn_f_link_release_udp_unicast(void *arg)
{
    _zn_link_t *self = (_zn_link_t*)arg;
...
size_t _zn_f_link_write_udp_unicast(void *arg, const uint8_t *ptr, size_t len)
{
    _zn_link_t *self = (_zn_link_t*)arg;

    return _zn_send_udp_unicast(self->sock, ptr, len, self->endpoint_syscall);
}

size_t _zn_f_link_write_all_udp_unicast(void *arg, const uint8_t *ptr, size_t len)
{
    _zn_link_t *self = (_zn_link_t*)arg;
...
size_t _zn_f_link_read_udp_unicast(void *arg, uint8_t *ptr, size_t len)
{
    _zn_link_t *self = (_zn_link_t*)arg;
...
size_t _zn_f_link_read_exact_udp_unicast(void *arg, uint8_t *ptr, size_t len)
{
    _zn_link_t *self = (_zn_link_t*)arg;
...
_zn_link_t *_zn_new_link_udp_unicast(_zn_endpoint_t *endpoint)
{
    ...
    lt->release_f = _zn_f_link_release_udp_unicast;
