...
size_t _zn_f_link_read_udp_unicast(const void *arg, uint8_t *ptr, size_t len)
{
    const _zn_link_t *self = (const _zn_link_t *)arg;
...
size_t _zn_f_link_read_exact_udp_unicast(const void *arg, uint8_t *ptr, size_t len)
{
    const _zn_link_t *self = (const _zn_link_t *)arg;
