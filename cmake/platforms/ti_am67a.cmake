# CMake platform profile for TI AM67A Cortex-R5F (FreeRTOS + lwIP, TI MCU+ SDK)
#
# Required environment/CMake variables:
#   MCU_PLUS_SDK_PATH   — root of the TI MCU+ SDK installation
...
if(NOT DEFINED MCU_PLUS_SDK_PATH OR MCU_PLUS_SDK_PATH STREQUAL "")
    if(DEFINED ENV{MCU_PLUS_SDK_PATH} AND NOT "$ENV{MCU_PLUS_SDK_PATH}" STREQUAL "")
        ...
        foreach(_sdk_dir
            "/opt/ti/mcu_plus_sdk_j722s_11_02_01_05"
            "/opt/ti/mcu_plus_sdk_j722s_11_02_00_00"
            "/opt/ti/mcu_plus_sdk_j722s_11_01_00_00")
        ...
        if(NOT DEFINED MCU_PLUS_SDK_PATH OR MCU_PLUS_SDK_PATH STREQUAL "")
            message(FATAL_ERROR
                ...
                "Example: cmake ... -DMCU_PLUS_SDK_PATH=/opt/ti/mcu_plus_sdk_j722s_11_02_01_05")
        endif()
    endif()
endif()

# ---- Platform identifiers --------------------------------------------------
# ZP_PLATFORM_SYSTEM_LAYER is informational; the actual dispatch uses ZENOH_TI_AM67A.
set(ZP_PLATFORM_SYSTEM_LAYER ti_am67a)
...
set(ZP_PLATFORM_SOURCE_FILES
    "${PROJECT_SOURCE_DIR}/src/system/ti_am67a/system.c"
    "${PROJECT_SOURCE_DIR}/src/system/ti_am67a/mem_pool.c"
...
set(Z_FEATURE_LINK_TCP 0 CACHE STRING "TCP disabled on ti_am67a (no unistd.h)" FORCE)
set(Z_FEATURE_LINK_TLS 0 CACHE STRING "TLS disabled on ti_am67a" FORCE)
set(Z_FEATURE_LINK_WS  0 CACHE STRING "WS disabled on ti_am67a" FORCE)

# Bare-metal target: static library only.
set(BUILD_SHARED_LIBS OFF CACHE BOOL "Static only on ti_am67a" FORCE)
