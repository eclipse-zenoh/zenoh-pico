...
function(zp_resolve_backend_descriptor name kind prefix)
...
macro(zp_resolve_udp_backend name)
  zp_resolve_backend_descriptor("${name}" "UDP transport backend" "ZP_UDP_BACKEND" ${ZP_UDP_BACKEND_DIRS})
endmacro()

macro(zp_resolve_tcp_backend name)
  zp_resolve_backend_descriptor("${name}" "TCP backend" "ZP_TCP_BACKEND" ${ZP_TCP_BACKEND_DIRS})
endmacro()

macro(zp_resolve_serial_backend name)
  zp_resolve_backend_descriptor("${name}" "serial backend" "ZP_SERIAL_BACKEND" ${ZP_SERIAL_BACKEND_DIRS})
endmacro()
