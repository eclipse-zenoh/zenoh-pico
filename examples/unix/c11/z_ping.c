...
int main(int argc, char** argv) {
    ...
    if (z_declare_publisher(&pub, z_loan(session), z_keyexpr("test/ping"), NULL) < 0) {
    ...
    if (z_declare_subscriber(&sub, z_loan(session), z_keyexpr("test/pong"), z_move(respond), NULL) < 0) {
